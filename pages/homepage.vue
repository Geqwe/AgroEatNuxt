        ...
        <v-main>
            <v-container fluid fill-height>
                <v-row align-bottom justify-center>
                    ...
                    <v-col cols=10 sm10 md10 lg10 xl10>
                            ...
                            <v-card-text>
                                <v-form>
                                    <v-row >
                                        ...
                                        <v-col cols=12 align="center" justify="center" sm12 md12 lg12 xl12>
                                            <v-data-table hide-actions text :headers="headers" :items="details" height="3">
                                                <template text slot="headerCell" slot-scope="props">
