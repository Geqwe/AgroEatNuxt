            ...
            <v-container grid-list-md text-cols=-center>
                <v-row >
                    <v-col cols=4 align="center" justify="center">
                        <v-expansion-panel expand v-model="panel"> <!-- panel gia ta notes -->
                            <v-expansion-panel-content>
                                ...
                                <v-btn text slot="header" color="grey" dark>Δελτια Αποστολης</v-btn>
                                <v-list>
                                    <v-divider class="black"></v-divider>
                                    <v-row id="names" v-for="note in filteredNotes" :key="note.id">
                                        <v-col grow>
                                            ...
                                            <v-card dark class="mb-1">
                                                <v-dialog ref="dial" v-model="dialog" persistent max-width="500px" dark>
                                                    ...
                                                    <v-card dark>
                                                        ...
                                                        <v-card-actions>
                                                            <v-spacer></v-spacer>
                                                            <v-btn @click="dialog=false" text color="grey" dark>No</v-btn>
                                                            <v-btn @click="delName=note.name;delId=myid;deleteNote();dialog=false;transition=false;" text color="grey" dark>Yes</v-btn>
                                                        </v-card-actions>
                                                    </v-card>
                                                </v-dialog>
                                            </v-card>
                    ...
                    <transition name="fade">
                        <v-col v-if="transition" cols=8 align="center" justify="center" > <!-- an einai anoixto ena field kai kleisto to dialog tou new field v-if="(infField == true && check==false)"-->
